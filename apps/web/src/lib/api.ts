...
const knownApiMessages: Record<string, string> = {
  ...
  'Student email is required.': 'Cargá un email para enviar la rutina.',
  'Student not found.': 'No encontramos el alumno.',
  'This link is no longer available.': 'Este enlace ya no está disponible.',
  'Transactional email authentication failed.': 'No pudimos autenticar el servidor de email. Revisá usuario y contraseña SMTP.',
  'Transactional email is not configured.': 'El envío de emails no está configurado en el servidor.',
  'Transactional email delivery failed.': 'No pudimos enviar el email. Revisá la configuración SMTP.',
  'Transactional email server is unreachable.': 'No pudimos conectar con el servidor SMTP. Revisá host, puerto y seguridad.',
